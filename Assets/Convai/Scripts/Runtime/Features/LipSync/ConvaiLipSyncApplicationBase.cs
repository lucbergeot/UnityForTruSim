...
namespace Convai.Scripts.Runtime.Features
{
    ...
    public abstract class ConvaiLipSyncApplicationBase : MonoBehaviour
    {
        ...
        public virtual void Initialize(ConvaiLipSync convaiLipSync, ConvaiNPC convaiNPC)
        {
            ...
            Debug.Log($"[ConvaiLipSyncApplicationBase] Initialized with head renderer: {HasHeadSkinnedMeshRenderer}, teeth renderer: {HasTeethSkinnedMeshRenderer}, tongue renderer: {HasTongueSkinnedMeshRenderer}");
        }
